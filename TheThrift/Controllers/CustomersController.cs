...
namespace TheThrift.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var collection = _mapper.Map<List<Customer>, List<CustomerVM>>(customers);
        ...
        public ActionResult Details(int id)
        {
            ...
            var collections = _mapper.Map<CustomerVM>(customers);
        ...
        public ActionResult Create(CustomerVM collection)
        {
            try
            {
                ...
                var customers = _mapper.Map<Customer>(collection);
        ...
        public ActionResult Edit(int id)
        {
            ...
            var customers = _repo.FindById(id);
            var collection = _mapper.Map<CustomerVM>(customers);
            return View(collection);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(CustomerVM collection)
        {
            try
            {
                ...
                var customer = _mapper.Map<Customer>(collection);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Delete(int id, CustomerVM collection)
        {
            try
            {
